    ...
    <head>
        ...
        <script>
            ...
            function guardaas()
            {
                ...
                {
                    alert("Error!!!...El Ajuste no esta cuadrado correctamente desea guardarlo!!!\n...");
                ...
                <div id="form2"> 
                    <div id="new_ejercicio">
                        <form name="form_ejercicio" id="form_ejercicio" method="post" action="ajustesasientos.php" style="width: 70%">
                            <input name="balances_realizados" id="balances_realizados" type="hidden" value="<?php echo $balances_realizados; ?>"/>
...
ORDER BY `t_ejercicio_idt_corrientes`";
                                        ...
                                        while ($rw = mysqli_fetch_assoc($result_grupo)) {
                                            ...
                                            while ($r2 = mysqli_fetch_array($result2)) {
                                                echo '<tr>';
                                                echo '<td width="5%" style="display:none">  ' . $r2['idajustesejercicio'] . '   </td>';
