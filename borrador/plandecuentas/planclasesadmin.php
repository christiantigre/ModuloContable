...
$c = $dbi->conexion();
    ...
    $accion=" / PLAN DE CUENTAS / Acceso a panel de clases";
            ...
            <div class="container banner">
                <div class="row">
                    <div class='col-md-4'>
                        ...
                        </strong><a href="planclasesadmin.php">Administraci&oacute;n de Clases</a>
                        <br>
                        <br>                    
                        <div class="menuadministracion">
                            <a class="toggleMenu" href="#"><img src="../../../images/nav_icon.png" alt="" /> </a>
                            <ul class="nav" id="nav">
                                <li class="current"><a href="planclasesadmin.php"><img src="../../../images/user.png" title="Plan de Cuentas" alt="Plan de Cuentas" />Cl&aacute;ses</a></li>
                ...
                <div id="contenedor">
                    ...
                    <div id="tabla">
                        <?php include_once('./consultaclasesadmin.php') ?>
                    </div>
                </div>
