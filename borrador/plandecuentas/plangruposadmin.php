...
//}
    ...
    $accion="Acceso a panel de grupos";
                    ...
                    <div class="clearfix">
                        ...
                        <div class="cajauser">
                            ...
                            <table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>&nbsp;</tr>
                                <tr>
                                    <td colspan="2"><div align="right">Usuario : 
                                            <span class="Estilo6"><strong><?php echo $user; ?> </strong></span></div></td>            
                                   <td></td>
            ...
            <div class="container banner">
                <div class="row">
                    <div class='col-md-4'>
                        ...
                        </strong><a href="plangruposadmin.php.php">Administraci&oacute;n de Grupos</a>
                        <br>
                        <br>                    
                        <div class="menuadministracion">
                            ...
                            <ul class="nav" id="nav">
                                ...
                                <li class="current"><a href="plangruposadmin.php"><img src="../../../images/users.png" title="Control de Usuarios" alt="Control de Usuarios" />Gr&uacute;pos</a></li>							
                ...
                <div id="contenedor">
                    ...
                    <div id="tabla">
                        <?php include('./consultagrupoadmin.php') ?>
                    </div>
                </div>
