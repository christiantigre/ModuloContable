...
self.location = "newcuenta_detalle.php"
        ...
        //echo "<script>alert('boton codigo');</script>";
        $c = $dbi->conexion();
            ...
            <div class="header">
                <div class="container header_top">
                    <div class="logo">
                        ...
                        <!--<a href="../../../templates/ModuloContable/index_modulo_contable.php"><img src="../../../images/logo.png" width="650" height="100" alt=""></a>-->
                    </div>
                    <div class="menu">
                ...
                <div class="row">
                    <div class='col-md-4'>
                        ...
                        <div class="menuadministracion">
                            <a class="toggleMenu" href="#"><img src="../../../images/nav_icon.png" alt="" /> </a>
                            <ul class="nav" id="nav">
                                <li><a href="planclasesadmin.php"><img src="../../../images/user.png" title="Plan de Cuentas" alt="Plan de Cuentas" />Cl&aacute;ses</a></li>
                                <li ><a href="plangruposadmin.php"><img src="../../../images/users.png" title="Control de Usuarios" alt="Control de Usuarios" />Gr&uacute;pos</a></li>							
                                <li class="current"><a href="plancuentaadmin.php"><img src="../../../images/ctas.png" title="Control de Usuarios" alt="Control de Usuarios" />Cuentas</a></li>							
                    ...
                    <div id="contenedor">
                        ...
                        <div id="tabla">
                            <span id="new"><a href="plancuentaadmin.php"><img src="../../../images/home_back.png" alt="Agregar dato" /></a></span>
