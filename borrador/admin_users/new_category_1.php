...
$query_cat = mysqli_query($c,$consulcat);
            ...
            <div class="container banner">
                <div class="row">
                    <div class='col-md-4'>
                        ...
                        </strong><a href="panel_users.php">Administraci&oacute;n de Categor&iacute;as</a>
                        <br>
                        <br>                    
                        ...
                        <div id="tabla">
                            ...
                            <form id="frmClienteNuevo" name="frmClaseNuevo" method="post" action="new_category.php">        
                                ...
                                <p>
                                    ...
                                    <input type="reset" class="btn"  name="cancelar" id="cancelar" value="Reset" onsubmit="<?php limpiarForm(); ?>"/>
