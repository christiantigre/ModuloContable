                        ...
                        <div class="menuadministracion">
                            ...
                            <ul class="nav" id="nav">
                                <li><a href="../admin_users/panel_users.php">
                                        <img src="../../../images/user.png" title="Plan de Cuentas" alt="Plan de Cuentas" />Categor&iacute;as</a>
                                </li>
                                <li class="current"><a href="panel_reg_user.php">
                                        <img src="../../../images/users.png" title="Control de Usuarios" alt="Control de Usuarios" />Usuarios</a>
                                </li>							
                ...
                function (respuestag) {
                    document.getElementById('pass').value = respuestag;
                                ...
                                <p>
                                    ...
                                    <input class="hidden" type="text" name="newcod_us" id="newcod_us" value="<?php echo $idcod; ?>" readonly="readonly"/>
                                </p>
                                <p><label>Nombre<br />
...
<!--                                <p><label>Tel&eacute;fono<br />
                                        <input class="text" type="text" name="tlf_us" id="tlf_us" />
                                    </label>
                                </p>
                                <p><label>Celular<br />
                                        <input class="text" type="text" name="cel_us" id="cel_us" />
                                    </label>
                                </p>-->
                                <p><label>Correo<br />
...
<!--                                <p><label>Nacionalidad<br />
                                        <input class="text" type="text" name="nac_us" id="nac_us" />
                                    </label>
                                </p>-->
                                <p><label>Cargo<br />
...
<!--                                <p><label>Foto<br />
                                        <input name="userfile" type="file" class="text" id="userfile">
                                    </label>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <!--<a href="" onclick="newuser()" class="btn">Guardar</a>-->
                                    <!--<input type="submit" name="submit" id="submit" onclick="newuser()" value="Guardar" />-->
                                    <!--<a href="" onclick="cancelar()" class="btn">Cancelar</a>-->
