...
if (isset($_POST["submit"])) {
    ...
    if ($btntu == "Enviar") {
        ...
        if ($objGrupo->insertarcuentaauxiliar(
                        array($nombre_cuenta, $cod_grupo, $descrip_cuenta, $cod_obtenidosubcuenta, $cod_obtenidocuenta, $cod_obtenidogrupp, $cod_obtenidoclase)) == true) {
                    ...
                    document.getElementById('nombredelgrupo').value = respuest;
                        ...
                        <div id="tabla">
                            ...
                            <form id="frmClienteNuevo" name="frmClaseNuevo" method="post" action="newcuenta_aux.php">        
                                <center>  <strong>Ingreso de Nueva Cta Auxiliar</strong> </center>
                                <p><label>Seleccione a que sub cuenta pertenecer&aacute;    : <br/> 
