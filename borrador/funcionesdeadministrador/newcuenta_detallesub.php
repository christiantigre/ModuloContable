                    ...
                    <div class='col-md-4'>
                        ...
                        <div class="menuadministracion">
                            ...
                            <ul class="nav" id="nav">
                                ...
                                <li class="current"><a href="plansubcuenta.php"><img src="../../../images/subcuenta.png" title="Subcuentas" alt="Subcuentas" />Sub-Cuentas</a></li>							
                    ...
                    document.getElementById('nombredelgrupo').value = respuest;
                        ...
                        <div id="tabla">
                            ...
                            <form id="frmClienteNuevo" name="frmClaseNuevo" method="post" action="newcuenta_detallesub.php">        
                                <center>  <strong>Ingreso de Nueva Cuenta</strong> </center>
                                <p><label>Seleccione a que cuenta pertenecer&aacute;    : <br/> 
