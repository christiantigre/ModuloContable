    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="container banner">
                <div class="row">
                    <div class='col-md-4'>
                        <a href="../../../index.php">  <img src="../../../images/Home.png" alt="" /> </a><strong> / </strong><a href="admincatalogodecuentas.php">Administraci&oacute;n Ctas de Detalle</a>
                        <br>
                        <br>                    
                        <div class="menuadministracion">
                            ...
                            <ul class="nav" id="nav">
                                ...
                                <li class="current"><a href="plancuen_detalle.php"><img src="../../../images/ctas.png" title="Control de Usuarios" alt="Control de Usuarios" />Cuentas</a></li>							
                ...
                <div id="contenedor">
                    ...
                    <div id="tabla">
                        <?php include('./consultacuenta_detalle.php') ?>
                    </div>
                </div>
