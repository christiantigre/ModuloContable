                        ...
                        <table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2"><div align="right">Usuario: <span class="Estilo6">
                                            <strong><?php echo $_SESSION['username']; ?> </strong></span></div></td>            
...
AND j.year = '" . $year . "' ";
                            ...
                            //AND e.fecha = n.fecha
                            $sqlbuscagrupos = "SELECT n.`idnum_asientos` AS id, n.`t_ejercicio_idt_corrientes` ej, n.`concepto` c,n.fecha
                                                ...
                                                <table class="table table-hover" id="tabedit">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            ?>
                                                    <input type="hidden" name="as" id="as" value="<?Php echo $codgrupo; ?>" />
                                                    <input type="hidden" name="f" id="f" value="<?Php echo $f; ?>" />
                                                    <input type="hidden" name="log" id="log" value="<?Php echo $idlogeobl; ?>" />
                                                    <button type="submit" class="btn btn-outline btn-info glyphicon glyphicon-print" 
                                                            onclick="imp_assin_ass_sec()"></button>
                                                    <?Php
...
//                    asdas
                        echo '</table>';
                        ?>
                        <input type="submit" name="update" id="update" class="btn btn-success" onclick="verifasslibsec()" value="ACTUALIZAR"/>
                    </form>
                </div>
                <!-- /#page-wrapper -->
            </div>
