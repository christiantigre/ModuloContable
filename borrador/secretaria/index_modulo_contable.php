...
while ($rw = mysqli_fetch_assoc($result_grupo)) {
    ...
    $resfserver = mysqli_query($dbi, $verfechaservidor);
...
while ($rw = mysqli_fetch_assoc($result_grupo)) {
    ...
    echo '<tr><th colspan="5" style="text-align: center;vertical-align: middle;"> Ref : ' . $codgrupo . '';
    if ($m_serv == $m_fech) {
        echo '<a href="updatasssec.php'
        . '?id_asientourl=' . $idasiento . '&fechaurl=' . $fecha . '&idlogeo=' . $idlogeobl . '" '
                . 'onclick="listar_secre();" "><img src="./../images/database_edit.png"'
