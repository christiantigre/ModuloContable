...
$_SESSION['loginu'] = $_SESSION['username'];
...
$accion = "Ingreso en registro de asientos en secretaria";
...
<html>
    <head>
        ...
        <script>
            ...
            function aux_save()
            {
                $('#form_ejerciciosecretaria').submit(function (msg) {
                                ...
                                <table width="718" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="2"><div align="right">Usuario: <span class="Estilo6">
                                                    <strong><?php echo $_SESSION['loginu']; ?> </strong>
                                                </span>
    ...
    <div id="form2"> 
        <div id="new_ejercicio">
            <form name="form_ejerciciosecretaria" id="form_ejerciciosecretaria" method="post" action="Bl_inicialsecre.php">
                <input type="hidden" name="idlog" id="idlog" value="<?Php echo $idlogeobl; ?>"/>
                <input type="hidden" name="balances_realizados" id="balances_realizados" value="<?Php echo $idcod; ?>"/>
