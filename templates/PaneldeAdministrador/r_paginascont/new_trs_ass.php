            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <form role="form" class="form-control" id="form" name="form" method="POST" action="new_trs_ass.php">
                            <!--<button type="button" class="btn btn-default" onclick="agregar_trs();">INSERTAR</button>-->
                            <button type="submit" class="btn btn-default" onclick="rr_agregar_new_ass();">INSERTAR</button>
