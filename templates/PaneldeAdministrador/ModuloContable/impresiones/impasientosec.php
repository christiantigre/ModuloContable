...
include '../../../Clases/guardahistorialimp.php';
    $accion=" / Impresión asiento ".$id_asientourl." fecha ".$date;
...
$sqlcargaconcepto = mysqli_query($db,"SELECT n.`idnum_asientos` AS id, n.`t_ejercicio_idt_corrientes` ej,
    n.`concepto` c, s.tipo_user AS Cargo, n.fecha AS f
FROM `num_asientos` n
JOIN totasientos e
JOIN logeo l
JOIN user_tipo s
