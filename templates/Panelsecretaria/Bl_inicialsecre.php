...
$accion = "/ CONTABILIDAD / ingreso a registro de asientos contables";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Bl_inicialsecre.php">
                        <?Php
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <form name="form_ejercicio" role="form" id="form_ejercicio" method="post" action="Bl_inicialsecre.php">
                                        <fieldset>
                                            <!--<legend-->

                                            <button type="button" title="ADD" class="btn btn-default" onclick="addasientoAs();">INSERTAR</button>
                                            <button type="submit" title="RESET" class="btn btn-success" onclick="ss_guardaaslibro()">GUARDAR</button>
                                            <button type="button" title="CANCEL" class="btn btn-primary" onclick="sec_reset_form()">CANCELAR</button>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" onblur="fcarga()" list="cuenta" name="cod_cuenta" id="cod_cuenta" class="form-control" value="" placeholder="Ingrese Cod Cuenta..."/>
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-default" onclick="fcarga()" type="button" id="btnver">Ver!</button>
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" placeholder="Concepto del Asiento..." maxlength="250" onkeyup="this.value = this.value.slice(0, 250)" id="textarea_as" name="textarea_as" cols="30" rows="3"></textarea>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <table class="table table-hover" width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablaDatosAs" id="tblDatosAs">
                                            <tbody>   
                                                <tr>
                                            <thead>
        ...
        <script>
                                                                    ...
                                                                    function sec_reset_form()
                                                                    {
                                                                        var answer = confirm("Deseas cancelar la edición?");
                                                                        if (answer) {
                                                                            window.location = '../Panelsecretaria/indexsec.php';
                                                                    ...
                                                                    function ss_aux_save()
                                                                    {
                                                                        $('#form_ejercicio').submit(function (msg) {
                                                                            $.post("./functions/guardaasientoslibro.php", $(this).serialize(), function (data) {
                                                                                alert(data);
                                                                    ...
                                                                    function imprimirasiento()
                                                                    {
                                                                        ...
                                                                        window.open('./impresiones/impasientosec.php?idlogeo=' + idlogeo +
                                                                                '&fechaurl=' + fech_url + '&id_asientourl=' + id_asientourl);
                                                                        window.location=('indexsec.php');
        ...
        <script language="javascript">
            ...
            function fcarga()
            {
                ...
                $.post("./functions/archivo.php", {"texto": miVariableJS},
                function (respuesta) {
            ...
            {
                var miVariableJS = $("#cod_cuenta").val();
                $.post("./functions/archivogrupo.php", {"texto": miVariableJS},
                function (respuestag) {
            ...
            {
                var miVariableJS = $("#cod_cuenta").val();
                $.post("./functions/archivogruponombre.php", {"texto": miVariableJS},
                function (respuestan) {
