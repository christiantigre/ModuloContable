                                                    ...
                                                    while ($r2 = mysqli_fetch_array($result2)) {
                                                        ...
                                                        <tr>
                                                            <td width="5%" style="display: none;"><?Php echo $r2['idt_corrientes']; ?>
                                                                <input type="text" class="form-control" name="idt_corrientes" id="idt_corrientes" value="<?Php echo $r2['idt_corrientes']; ?>"  />
                                                                <input type="text" class="form-control" name="campo1[]" id="idt_cont<?Php echo $c; ?>" value="<?Php echo $r2['idt_corrientes']; ?>"  />
                                                            <td width="35%">
...
//                    echo '</center>';
                    ...
                    <input type="submit" name="update" id="update" class="btn btn-success" onclick="verif()" value="ACTUALIZAR"/>
                    </form>
                </div>
                <!-- /#page-wrapper -->
            </div>
