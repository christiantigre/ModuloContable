...
if ($foto != "") {
    ...
    $pdf->Image($img, 10, 3, 280, 20, $tip);
} Else {
    $pdf->Image("../../../../images/fondoAzul.png", 10, 3, 220, 20, "png");
}
$pdf->Cell(18, 10, '', 0);
...
while ($row4 = mysqli_fetch_array($sql_cargasumas)) {
    ...
    $sumatotdeb = number_format($row4['sumatotdeb'], 2, '.', '');
    $sumatothab = number_format($row4['sumatothab'], 2, '.', '');
    
    $pdf->Cell(18, 8, $sumdebe, 0);
    $pdf->Cell(18, 8, $sumhaber, 0);
    $pdf->Cell(18, 8, $sumslddeud, 0);
    $pdf->Cell(18, 8, $sumsldacreed, 0);
    $pdf->Cell(18, 8, $s_deb_aj, 0);
    $pdf->Cell(18, 8, $sum_hab_aj , 0);
    $pdf->Cell(18, 8, $sum_slddeu_aj, 0);
    $pdf->Cell(18, 8, $sum_slsacreed_aj, 0);
    $pdf->Cell(18, 8, $sumatotdeb, 0);
    $pdf->Cell(18, 8, $sumatothab, 0);
}
