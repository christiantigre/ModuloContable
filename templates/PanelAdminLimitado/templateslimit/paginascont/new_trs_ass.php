                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <form role="form" class="form-control" id="form" name="form" method="POST" action="new_trs.php">
                            ...
                            <button type="submit" class="btn btn-default" onclick="agregar_new_ass();">INSERTAR</button>
                            <input type="hidden" name="datetimepickert" id="datetimepickert" value="<?Php echo $fecha; ?>" />                   
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="input-group">
                                            <input type="text" onblur="compr_t()" list="cuenta" name="cod_cuentat" id="cod_cuentat" class="form-control" value="" placeholder="Ingrese Cod Cuenta..."/>
