...
' . $bk->langTxt('') . ' <input class="form-control" type="hidden" name="host" value="localhost"><br>
...
' . $bk->langTxt('') . ' <input class="form-control" type="hidden" name="dbname" value="condata"><br>
